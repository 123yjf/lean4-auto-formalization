...
INPUT_DIR = "data/lean_reference_set"
OUTPUT_DIR = "results/txt_reference_translations"
...
def process_file(file_path):
    try:
        ...
        response = client.chat.completions.create(
            model=MODEL,
            messages=[
                {"role": "system", "content": "You are a Lean4 proof translator. Translate Lean4 proofs into clear English explanations."},
